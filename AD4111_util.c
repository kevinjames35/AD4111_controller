			...
			if(iResult == 1)
			{
				...
				if(iResult == 1)
				{
					...
					if(iResult == 1)
					{
						//printf("read success\n");
						//printf("%s\n",rdData);
						if(str_to_hex(rdData)==1)printf("Module type : differential voltage mode\n");
						else if(str_to_hex(rdData)==2)printf("Module type : current mode\n");
						else if(str_to_hex(rdData)==3)printf("Module type : singled-end voltage mode\n");
						else printf("error\n");
